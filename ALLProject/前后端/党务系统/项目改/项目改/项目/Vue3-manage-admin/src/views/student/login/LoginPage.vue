...
import { userUpdateStatus } from '@/api/person.js'
import { useUserStore } from '@/stores'
import { ElMessage } from 'element-plus'
import { useRouter } from 'vue-router'
import { Promotion, Comment } from '@element-plus/icons-vue'
...
const rules1 = {
  username: [
    ...
    { pattern: /^\S{10}$/, message: '用户名必须是10位的学号', trigger: 'blur' }
  ],
  password: [
...
const getCode = async () => {
  ...
  checkCode.value = await getCodeByStuEmail(
...
const onsubmit = async () => {
  loadingPsw.value = true
  //console.log(emailModel.value.username)
...
userStore.userRole = options[1].value
      ...
      >
        ...
        <el-form-item inline prop="code">
          ...
          <el-button
            ...
            <span v-else>重新发送{{ obj.count }}s</span></el-button
          >
        </el-form-item>
      </el-form>
    </div>
