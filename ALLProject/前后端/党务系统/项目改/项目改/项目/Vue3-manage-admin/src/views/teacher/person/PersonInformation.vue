...
import { Search, Edit, View, Hide } from '@element-plus/icons-vue'
  ...
  <page-container title="人员信息管理">
    <template #extra>
        <template v-if="isShow === false">
            <el-button @click="display('View')">点击显示信息</el-button>
        </template>
        <template v-if="isShow === true">
            <el-button @click="display('Hide')">点击隐藏信息</el-button>
        </template>

      <el-button @click="OutExcel">信息导出</el-button>
    </template>
    <!-- 搜索栏 -->
    <el-collapse>
