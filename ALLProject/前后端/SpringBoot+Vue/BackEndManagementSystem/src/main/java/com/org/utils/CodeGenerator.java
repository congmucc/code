        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/Bms?useSSL=false", "root", "123456")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.org") // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapper.xml, "D:\\Code\\Project\\SpringBoot+Vue\\BackEndManagementSystem\\src\\main\\resources\\mapper\\")); // 设置mapperXml生成路径
                })
