...
plt.bar(range(len(best_solution)), best_solution, color='blue', alpha=0.7)
plt.xlabel('测线', fontsize=12)
plt.ylabel('距离海域西的位置（米）', fontsize=12)
plt.title('最优测线表', fontsize=14)
plt.grid(True)
plt.show()
